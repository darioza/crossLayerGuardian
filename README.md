...
```bash
cd crossLayerGuardian/crossLayerGuardian\ -\ code/
...
Baseado na validação experimental da dissertação (Fase 2 - Implementação Avançada):
...
- Compensação drift <0.1ppm conforme dissertação
...
#### 4. EventCorrelator Avançado (`event_correlator.py`)
...
#### 6. AdvancedMonitor (`advanced_monitor.py`) **[NOVO - Fase 2]**
- **Sistema de monitoramento inteligente**:
  - Coleta de métricas em tempo real
  - Detecção automática de anomalias
  - Alertas adaptativos com auto-resolução
  - Análise de tendências de longo prazo
- **Auto-tuning**: Ajuste automático baseado em performance
- **Relatórios detalhados**: Performance scores e insights

### 🤝 Contribuições

Este código implementa a arquitetura descrita na dissertação de mestrado:

**"CrossLayerGuardian: Arquitetura eBPF para Correlação Cross-layer em Sistemas de Detecção de Intrusão"**
...
Este projeto é baseado em pesquisa acadêmica. Para uso comercial, consulte os autores.

### 🔗 Referências

- Dissertação completa: [Link para dissertação]
- Artigos relacionados: [Links para publicações]
- Dataset CICIDS2018: [Link oficial]